...
import 'package:common/presentation/button/profile_button.dart';
import 'package:common/presentation/api_loader/response_builder.dart';
import 'package:common/presentation/loader_overlay/stream_loader_overlay.dart';
...
class LihatStockBarangScreen extends StatefulWidget {
  const LihatStockBarangScreen({Key? key}) : super(key: key);

  @override
  State<LihatStockBarangScreen> createState() => _LihatStockBarangScreenState();
}

class _LihatStockBarangScreenState extends State<LihatStockBarangScreen> {
  final logoutProgressObserver = StreamController<ResponseWrapper<Object?, Object?>>();


  @override
  void dispose() {
    logoutProgressObserver.close();
    super.dispose();
  }
    ...
    return MultiProvider(
      ...
      child: RefreshNotifierListener(
        ...
        builder: (context) {
          ...
          return StreamLoaderOverlay(
            stream: logoutProgressObserver.stream,
            child: Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  ProfileButton(onLogoutProgressing: (event){
                    logoutProgressObserver.add(event);
                  },),
                ],
              ),
