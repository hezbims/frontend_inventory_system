...
import 'package:fitur_input_form_data_barang/data/api_client/submit_barang_api_client.dart';
import 'package:fitur_input_form_data_barang/data/mapper/error_form_barang_mapper.dart';
...
class SubmitBarangRepositoryImpl implements ISubmitBarangRepository {
  ...
  final _mapper = ErrorFormBarangMapper();
  @override
